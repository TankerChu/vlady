            ...
            <div class=" col-lg-4 col-md-6 mb-5 mb-md-5">
                ...
                <div class="ftco-footer-widget mb-4" style="padding-top:1%">
                    <div class="block-23 mb-3">
                        <ul>
                            <li><a href="#"><span class="icon icon-map-marker"><i class="fas fa-map-marked-alt"></i></span><span class="text">429/44, Thụy Khuê, Tây Hồ, Hà
                                        Nội</span></a></li>
                            <li><a href="#"><span class="icon icon-phone"><i class="fas fa-phone-alt"></i></span><span class="text">094 616 9779 / 024 33 98
                                        9999</span></a></li>
                            <li><a href="#"><span class="icon icon-envelope"><i class="fas fa-envelope"></i></span><span class="text">hotro@vlady.vn</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                            <li class="ftco-animate"><a class="footer-icon"
                                    href="https://www.youtube.com/channel/UCdU44faIOEuxQhiN-qcn4KQ"><span>
                                        <i class="fab fa-youtube"></i></a></span><a class="popup-with-zoom-anim"
                            ...
                            <div id="small-dialog-youtube" class="zoom-anim-dialog mfp-hide">
                                <img src="images\footer\youtubecoverfullsz 2.jpg" alt="youtube channel">
                            ...
                            <li class="ftco-animate"><a class="footer-icon"
                                    href="https://www.facebook.com/hocvienyeuVlady/"><span>
                                        <i class="fab fa-facebook-f"></i></span><a class="popup-with-zoom-anim"
                            ...
                            <li class="ftco-animate"><a class="footer-icon"
                                    href="https://www.instagram.com/nhung.lady/"><span>
                                        <i class="fab fa-instagram"></i></a></span><a class=".popup-with-zoom-anim"
                                    href="#small-dialog"><strong style="color:white">NhungLady - Phù
                                        Thủy phòng the</strong></a>2222 Followers - 119 posts</li>
                            <li class="ftco-animate"><a class="footer-icon"
                                    href="https://www.instagram.com/nhung.lady/"><span>
                                        <i class="fab fa-twitter"></i></a></span><a class=".popup-with-zoom-anim"
                                    href="#small-dialog"><strong style="color:white">NhungLady - Phù
                                        Thủy phòng the</strong></a>2222 Followers - 119 posts</li>
                        </ul>
                    </div>
