...
@section('banner')
<section class="hero-wrap js-fullheight" style=" font-family: Roboto;">
	<div class="fs-carousel"
		...
		<div class="carousel-cell" \>
			<video autoplay loop>
				<source src="/img/Sexy-Dancer-Slowly-Touching-2.webmsd.webm" type="video/webm">
				<source src="/img/Sexy-Dancer-Slowly-Touching-2.mp4.mp4" type="video/mp4">
		...
		<div class="carousel-cell" data-flickity-bg-lazyload="{{ asset('img/1546591430121.png') }}">
		...
		<div class="carousel-cell" data-flickity-bg-lazyload="{{ asset('img/1546591445513.png') }}">
			<div class="chat_vol2 carousel-fade">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
		...
		<div class="carousel-cell"
			data-flickity-bg-lazyload="{{ asset('img/phu-nu-a-dung-xem-dan-ong-la-tat-ca.png') }}">
			<div class="chat_vol2 carousel-fade">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
...
<section class="ftco-section" id="why" style="font-family: Roboto;">
	<div class="container">
		<div class="row justify-content-center mb-5">
			<div class="col-md-10 heading-section text-center ftco-animate">
				<span class="subheading">
					<i class="db-left"></i>
					Tại sao cần học kỹ năng phòng the ngày hôm nay?
					<i class="db-right"></i>
				</span>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6" style=" background-image: url();">
					<h4>Về Chúng Tôi</h4>
				...
				<div class="col-lg-6">
					<h4>Về Chúng Tôi</h4>
					<div class='embed-container'><iframe src='https://www.youtube.com/embed/LG0FHYgMtAE' frameborder='0'
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="services text-center ftco-animate">
					<div class="d-flex justify-content-center align-items-center">
						<span class=""><img src="{{ asset('img/icon/icons8_trophy_100px.png') }}"></span>
					</div>
			...
			<div class="col-md-3">
				<div class="services text-center ftco-animate">
					<div class="d-flex justify-content-center align-items-center">
						<span class=""><img src="{{ asset('img/icon/icons8_classroom_100px.png') }}"></span>
					</div>
					<div class="text px-md-2">
			...
			<div class="col-md-3">
				<div class="services text-center ftco-animate">
					<div class="d-flex justify-content-center align-items-center">
						<span class=""><img src="{{ asset('img/icon/icons8_light_on_100px_2.png') }}"></span>
					</div>
					<div class="text px-md-2">
			...
			<div class="col-md-3">
				<div class="services text-center ftco-animate">
					<div class="d-flex justify-content-center align-items-center">
						<span class=""><img src="{{ asset('img/icon/icons8_lightning_bolt_100px_2.png') }}"></span>
					</div>
					<div class="text px-md-2">
				...
				<div class="row">
					<div class="col d-flex justify-content-center counter-wrap ftco-animate" style="padding-left: 30px">
						<div class="block-18 text-center">
							<img src="{{ asset('img/icon/icons8_courses_50px.png') }}">
							<div class="text">
					...
					<div class="col d-flex justify-content-center counter-wrap ftco-animate" style="padding-left: 30px">
						<div class="block-18 text-center">
							<img src="{{ asset('img/icon/icons8_student_50px.png') }}">
							<div class="text">
					...
					<div class="col d-flex justify-content-center counter-wrap ftco-animate" style="padding-left: 30px">
						<div class="block-18 text-center">
							<img src="{{ asset('img/icon/icons8_date_50px.png') }}">
							<div class="text">
					...
					<div class="col d-flex justify-content-center counter-wrap ftco-animate" style="padding-left: 30px">
						<div class="block-18 text-center">
							<img src="{{ asset('img/icon/icons8_classroom_50px_1.png') }}">
							<div class="text">
				...
				<div class="pricing-wrap ftco-animate img"
					...
					<div class="text p-4 d-flex align-items-end">
						<a href="{{ route('course', [$featured->slug, $featured->id]) }}"
							class="btn-custom px-4 py-2">Tham Gia Ngay</a>
						<div>
...
<section class="ftco-section" style="font-family: Roboto;">
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-md-4">
				<div class="pricing-wrap ftco-animate img"
					style="background-image: url('{{ asset('img/1568026404394.jpg') }} ');">
					<div class="title p-4">
			...
			<div class="col-md-4">
				<div class="pricing-wrap ftco-animate img"
					style="background-image: url('{{ asset('img/1568026811516.png') }} ');">
					<div class="title p-4">
			...
			<div class="col-md-4 mx-auto">
				<div class="pricing-wrap ftco-animate img"
					style="background-image: url('{{ asset('img/051913-07092018-41267202_1113252155491395_5200092298846666752_n.jpg') }} ');">
					<div class="title p-4">
			...
			<div class="col-md-4">
				<div class="pricing-wrap ftco-animate img"
					style="background-image: url('{{ asset('img/1568026661007.png') }} ');">
					<div class="title p-4">
			...
			<div class="col-md-4">
				<div class="pricing-wrap ftco-animate img"
					style="background-image: url('{{ asset('img/1563853137057.jpg') }} ');">
					<div class="title p-4">
			...
			<div class="col-md-4">
				<div class="pricing-wrap ftco-animate img"
					style="background-image: url('{{ asset('img/bi-mat-ve-thu-dam-o-phu-nu-03-1024x672.jpg') }} ');">
					<div class="title p-4">
		...
		<div class="row no-gutters">
			<div class="col-lg-6 d-flex">
				<div class="coach d-sm-flex align-items-stretch">
					<div class="img"
						style="background-image: url('{{ asset('img/1546591460673%20%281%29fixed.png') }} ');">
					</div>
			...
			<div class="col-lg-6 d-flex">
				<div class="coach d-sm-flex align-items-stretch">
					<div class="img" style="background-image: url('{{ asset('img/') }} ');"></div>
		...
		<div id="bs4-multi-slide-carousel" class="carousel slide" data-ride="carousel">
			<div class="carousel-inner">
				<div class="carousel-item active">
					<div class="row">
						<div class="col"><img src="{{ asset('img/unesco-logo.jpg') }}" class="img-fluid" alt="1 slide">
						</div>
						<div class="col"><img src="{{ asset('img/unicef-logo.png" class="img-fluid" alt="2 slide') }}">
						</div>
						<div class="col"><img
								src="{{ asset('img/nielsen-logo-1200x675-1.jpg" class="img-fluid" alt="3 slide') }}">
						</div>
					</div>
				</div>
				<div class="carousel-item">
					<div class="row">
						<div class="col"><img src="{{ asset('img/download.png') }}" class="img-fluid" alt="1 slide">
						</div>
						<div class="col"><img src="{{ asset('img/unesco-logo.jpg') }}" class="img-fluid" alt="2 slide">
						</div>
						<div class="col"><img src="{{ asset('img/unicef-logo.png') }}" class="img-fluid" alt="3 slide">
						</div>
					</div>
				</div>
				<div class="carousel-item">
					<div class="row">
						<div class="col"><img src="{{ asset('img/nielsen-logo-1200x675-1.jpg') }}" class="img-fluid"
								alt="1 slide"></div>
						<div class="col"><img src="{{ asset('img/download.png') }}" class="img-fluid" alt="2 slide">
						</div>
						<div class="col"><img src="{{ asset('img/unicef-logo.png') }}" class="img-fluid" alt="3 slide">
						</div>
					</div>
			...
			<div class="col-lg-4 d-flex ftco-animate">
				<div class="blog-entry align-self-stretch">
					<a href="http://nuhoangphongthe.com/nu_hoang_phong_the/ban-ron-tren-giuong-giup-phu-nu-tre-lau/"
						class="block-20"
						style="background-image: url('{{ asset('img/ban-ron-tren-giuong-giup-phu-nu-tre-lau.jpg') }} ');">
					</a>
			...
			<div class="col-lg-4 d-flex ftco-animate">
				<div class="blog-entry align-self-stretch">
					<a href="http://nuhoangphongthe.com/nhap-mon-tinh-duc-hoc/diem-nhay-cam-kich-thich-chang-khi-yeu/"
						class="block-20"
						style="background-image: url('{{ asset('img/diem-nhay-cam-kich-thich-chang-khi-yeu-1000x570.png') }} ');">
					</a>
					<div class="text py-4 d-flex">
						<div class="desc">
							<h3 class="heading mt-2"><a
			...
			<div class="col-lg-4 d-flex ftco-animate">
				<div class="blog-entry align-self-stretch">
					<a href="http://nuhoangphongthe.com/nu_hoang_phong_the/7-buoc-de-dua-chang-len-dinh-bang-mieng/"
						class="block-20"
						style="background-image: url('{{ asset('img/7-buoc-de-dua-chang-len-dinh-bang-mieng-1000x570.png') }} ');">
					</a>
					<div class="text py-4 d-flex">
						<div class="desc">
							<h3 class="heading mt-2"><a
