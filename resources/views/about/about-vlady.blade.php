...
<section class="hero-wrap js-fullheight">
	<div class="overlay" style="background-image: url('{{ asset('img/1546591477050.png') }}' )"></div>
</section>
<!-- {{-- hết banner --}} -->
@endsection
...
<section class="ftco-about d-md-flex">
	<div class="one-half img" style="background-image: url('{{ asset('img/1541528243053.jpg') }}' );">
